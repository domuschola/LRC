        ...
        return (
            <div className = "burger">
                <svg id="burger_svg" width="88" height="109" viewBox="0 0 88 109" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g filter="url(#burger_circle)">
                        <circle id="circle" cx="44" cy="40" r="35" fill="#A11C21" />
                    </g>
                    ...
                    <defs>
                        <filter id="burger_circle" x="0" y="0" width="88" height="88" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
